// MQ2DanCast.cpp : Defines the entry point for the DLL application.
//
...
{
	DebugSpewAlways("Initializing MQ2DanCast");
...
{
	DebugSpewAlways("Shutting down MQ2DanCast");
...
{
	DebugSpewAlways("MQ2DanCast::OnZoned()");
}
...
{
	DebugSpewAlways("MQ2DanCast::OnCleanUI()");
...
{
	DebugSpewAlways("MQ2DanCast::OnReloadUI()");
...
PLUGIN_API VOID OnDrawHUD(VOID)
{
	...
	//DebugSpewAlways("MQ2DanCast::OnDrawHUD()");
}

// Called once directly after initialization, and then every time the gamestate changes
PLUGIN_API VOID SetGameState(DWORD GameState)
{
	DebugSpewAlways("MQ2DanCast::SetGameState()");
...
{
	// DONT leave in this debugspew, even if you leave in all the others
	//DebugSpewAlways("MQ2DanCast::OnPulse()");
}
...
{
	DebugSpewAlways("MQ2DanCast::OnWriteChatColor(%s)", Line);
	return 0;
}
...
{
	DebugSpewAlways("MQ2DanCast::OnIncomingChat(%s)", Line);
	return 0;
}
...
{
	DebugSpewAlways("MQ2DanCast::OnAddSpawn(%s)", pNewSpawn->Name);
}
...
{
	DebugSpewAlways("MQ2DanCast::OnRemoveSpawn(%s)", pSpawn->Name);
}
...
{
	DebugSpewAlways("MQ2DanCast::OnAddGroundItem(%d)", pNewGroundItem->DropID);
}
...
{
	DebugSpewAlways("MQ2DanCast::Zoned");
}
